      ...
      <div class="card h-100 radius-8 border">
        <div class="card-body p-24">
          <div class="d-flex align-items-center flex-wrap gap-2 justify-content-between">
            <div>
              <h6 class="mb-2 fw-bold text-lg">Loan Applications</h6>
              <span class="text-sm fw-medium text-secondary-light">Monthly Report</span>
            </div>
            <div class="text-end">
          ...
          <div id="loan-application-chart" class="mt-28"></div>
    ...
    <div class="col-xxl-8">
      <div class="card h-100 radius-8 border-0">
        <div class="card-body p-24">
          <div class="d-flex align-items-center flex-wrap gap-2 justify-content-between">
            <div>
                <h6 class="mb-2 fw-bold text-lg">Loan Application Statistics</h6>
                <span class="text-sm fw-medium text-secondary-light">Overview of Loan Applications by Time Period</span>
            </div>
          ...
          <div class="mt-20 d-flex justify-content-center flex-wrap gap-3">
            ...
            <div class="d-inline-flex align-items-center gap-2 p-2 radius-8 border pe-36 br-hover-primary group-item">
              ...
              <div>
                <span class="text-secondary-light text-sm fw-medium">Total Applications</span>
                <h6 class="text-md fw-semibold mb-0">1,200</h6>
              </div>
            </div>
            ...
            <div class="d-inline-flex align-items-center gap-2 p-2 radius-8 border pe-36 br-hover-primary group-item">
              <span class="bg-neutral-100 w-44-px h-44-px text-xxl radius-8 d-flex justify-content-center align-items-center text-secondary-light group-hover:bg-primary-600 group-hover:text-white">
                <iconify-icon icon="bi:cash-stack" class="icon"></iconify-icon>
              </span>
              <div>
                <span class="text-secondary-light text-sm fw-medium">Total Loan Amount</span>
                <h6 class="text-md fw-semibold mb-0">$5M</h6>
              </div>
            </div>
            ...
            <div class="d-inline-flex align-items-center gap-2 p-2 radius-8 border pe-36 br-hover-primary group-item">
              ...
              <div>
                <span class="text-secondary-light text-sm fw-medium">Approval Rate</span>
                <h6 class="text-md fw-semibold mb-0">75%</h6>
              </div>
            </div> --}}

            <div>
                <span class="text-secondary-light text-sm fw-medium">Total Applications</span>
                <h6 class="text-md fw-semibold mb-0" id="totalApplications">Loading...</h6>
            </div>
            <div>
                <span class="text-secondary-light text-sm fw-medium">Total Loan Amount</span>
                <h6 class="text-md fw-semibold mb-0" id="totalLoanAmount">Loading...</h6>
            </div>
            <div>
                <span class="text-secondary-light text-sm fw-medium">Approval Rate</span>
                <h6 class="text-md fw-semibold mb-0" id="approvalRate">Loading...</h6>
            </div>
