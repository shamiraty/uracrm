...
class RetirementExport implements FromCollection, WithHeadings
{
    ...
    public function collection()
    {
        ...
        $query = Retirement::with([
                ...
                'enquiry.branch',
                'enquiry.command',
                'enquiry.assignedUsers' // Required for role-based filtering.
            ])
        ...
        // For registrar roles, limit results to enquiries registered by the current user.
        ...
        return $query->get()->map(function ($retirement) {
