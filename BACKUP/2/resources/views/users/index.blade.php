        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-0">
                ...
                <ul class="nav nav-tabs analytics-tabs mx-4 mt-4" id="analyticsTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="unauthorized-tab" data-bs-toggle="tab" data-bs-target="#unauthorized" type="button" role="tab">
                            <i class="bx bx-shield-x me-2"></i>Unauthorized Access
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                ...
                <div class="tab-content" id="analyticsTabContent">
                    ...
                    <div class="tab-pane fade" id="unauthorized" role="tabpanel">
                        <div class="p-4">
                            <!-- Unauthorized Access Header -->
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <h5 class="text-danger mb-0">
                                    <i class="bx bx-shield-x me-2"></i>Unauthorized Access Attempts Monitoring
                                </h5>
                                <div class="d-flex gap-2">
                                    <button type="button" class="btn btn-outline-success btn-sm" onclick="exportUnauthorizedExcel()">
                                        <i class="bx bx-file-export"></i> Export Excel
                                    </button>
                                    <button type="button" class="btn btn-outline-danger btn-sm" onclick="exportFrequentAttemptsPDF()">
                                        <i class="bx bx-file-pdf"></i> Frequent Attempts PDF
                                    </button>
                                    <button type="button" class="btn btn-outline-warning btn-sm" onclick="exportFrequentAttemptsCSV()">
                                        <i class="bx bx-file-csv"></i> Frequent Attempts CSV
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="row g-4 mb-4">
                                <div class="col-lg-3 col-md-6">
                                    <div class="analytics-metric-card border-danger">
                                        <div class="metric-icon bg-danger-subtle">
                                            <i class="bx bx-shield-x text-danger"></i>
                                        </div>
                                        <div class="metric-value text-danger" id="total-unauthorized-attempts">-</div>
                                        <div class="metric-label">Total Attempts</div>
                                        <div class="metric-change negative">
                                            <i class="bx bx-trending-up"></i> Last 7 days
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <div class="analytics-metric-card border-warning">
                                        <div class="metric-icon bg-warning-subtle">
                                            <i class="bx bx-user-x text-warning"></i>
                                        </div>
                                        <div class="metric-value text-warning" id="unique-violators">-</div>
                                        <div class="metric-label">Unique Users</div>
                                        <div class="metric-change">
                                            <i class="bx bx-user"></i> With attempts
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <div class="analytics-metric-card border-info">
                                        <div class="metric-icon bg-info-subtle">
                                            <i class="bx bx-calendar-today text-info"></i>
                                        </div>
                                        <div class="metric-value text-info" id="today-attempts">-</div>
                                        <div class="metric-label">Today's Attempts</div>
                                        <div class="metric-change">
                                            <i class="bx bx-time"></i> Real-time
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <div class="analytics-metric-card border-primary">
                                        <div class="metric-icon bg-primary-subtle">
                                            <i class="bx bx-trending-up text-primary"></i>
                                        </div>
                                        <div class="metric-value text-primary" id="frequent-offenders">-</div>
                                        <div class="metric-label">Frequent Offenders</div>
                                        <div class="metric-change">
                                            <i class="bx bx-error"></i> 3+ attempts
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="analytics-table-container">
                                <div class="p-3 border-bottom d-flex justify-content-between align-items-center">
                                    <h6 class="text-danger mb-0">
                                        <i class="bx bx-list-ul me-2"></i>Recent Unauthorized Access Attempts
                                    </h6>
                                    <div class="d-flex gap-2">
                                        <button type="button" class="btn btn-outline-primary btn-sm" onclick="refreshUnauthorizedData()">
                                            <i class="bx bx-refresh"></i> Refresh
                                        </button>
                                        <span class="badge bg-danger" id="unauthorized-count-badge">0</span>
                                    </div>
                                </div>
                                <div class="table-responsive">
                                    <table class="table analytics-table mb-0" id="unauthorizedAccessTable">
                                        <thead class="table-danger">
                                            <tr>
                                                ...
                                                <th style="width: 15%;">Page Attempted</th>
                                                <th style="width: 10%;">Date</th>
                                                <th style="width: 8%;">Time</th>
                                            </tr>
                                        </thead>
                                        <tbody id="unauthorizedAccessBody">
                                            <tr>
                                                <td colspan="9" class="text-center text-muted py-4">
                                                    <i class="bx bx-loader-alt bx-spin me-2"></i>Loading unauthorized access data...
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class="alert alert-warning mt-4" role="alert">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        <h6 class="alert-heading mb-1">Security Monitoring Notice</h6>
                                        <p class="mb-2">This system automatically logs all unauthorized access attempts. Users with frequent violations (3+ attempts) trigger automatic SMS alerts to system administrators.</p>
                                        <ul class="mb-0 small">
                                            <li>All access attempts are logged with user details, timestamps, and attempted resources</li>
                                            <li>Frequent violators are automatically reported to superadmins via SMS</li>
                                            <li>This data is used for security auditing and role permission reviews</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
// Load unauthorized access data when tab is clicked
document.addEventListener('DOMContentLoaded', function() {
    const unauthorizedTab = document.getElementById('unauthorized-tab');
    if (unauthorizedTab) {
...
function loadUnauthorizedData() {
    fetch('{{ route("unauthorized.access.data") }}')
        .then(response => response.json())
        .then(data => {
            updateUnauthorizedMetrics(data);
            populateUnauthorizedTable(data.attempts);
        })
        .catch(error => {
            console.error('Error loading unauthorized access data:', error);
            document.getElementById('unauthorizedAccessBody').innerHTML = `
                <tr>
                    <td colspan="9" class="text-center text-danger py-4">
                        <i class="bx bx-error me-2"></i>Error loading data. Please refresh the page.
                    </td>
                </tr>
            `;
        });
...
function updateUnauthorizedMetrics(data) {
    document.getElementById('total-unauthorized-attempts').textContent = data.total_count || 0;
    document.getElementById('unique-violators').textContent = data.attempts ? [...new Set(data.attempts.map(a => a.user_name))].length : 0;
    document.getElementById('today-attempts').textContent = data.today_count || 0;

    // Count frequent offenders (appearing 3+ times)
    const userCounts = {};
    if (data.attempts) {
        data.attempts.forEach(attempt => {
            userCounts[attempt.user_name] = (userCounts[attempt.user_name] || 0) + 1;
        });
    }
    const frequentOffenders = Object.values(userCounts).filter(count => count >= 3).length;
    document.getElementById('frequent-offenders').textContent = frequentOffenders;

    document.getElementById('unauthorized-count-badge').textContent = data.attempts ? data.attempts.length : 0;
}

function populateUnauthorizedTable(attempts) {
    const tbody = document.getElementById('unauthorizedAccessBody');

    if (!attempts || attempts.length === 0) {
        tbody.innerHTML = `
            <tr>
                <td colspan="9" class="text-center text-success py-4">
                    <i class="bx bx-check-circle me-2"></i>No unauthorized access attempts found. System security is functioning properly!
                </td>
            </tr>
        `;
        return;
    ...
    attempts.forEach((attempt, index) => {
        ...
        html += `
            <tr class="${rowClass}">
                <td class="fw-medium">${attempt.user_name}</td>
                <td>${attempt.user_phone}</td>
                <td><span class="badge bg-warning">${attempt.user_role}</span></td>
                <td>${attempt.region}</td>
                <td>${attempt.branch}</td>
                <td>${attempt.district}</td>
                <td class="text-danger small">${attempt.route_attempted}</td>
                <td>${attempt.date}</td>
                <td class="small">${attempt.time}</td>
            </tr>
        `;
    });
...
function refreshUnauthorizedData() {
    const refreshBtn = document.querySelector('button[onclick="refreshUnauthorizedData()"]');
...
function exportFrequentAttemptsPDF() {
    const form = document.createElement('form');
    form.method = 'POST';
    form.action = '{{ route("unauthorized.access.export.frequent.pdf") }}';
...
function exportFrequentAttemptsCSV() {
    const form = document.createElement('form');
    form.method = 'POST';
    form.action = '{{ route("unauthorized.access.export.frequent.csv") }}';
