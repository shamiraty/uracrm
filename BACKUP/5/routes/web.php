...
Route::middleware(['role:branch_manager'])->group(function () {
    ...
    Route::get('/branches/manager/region-analytics', [BranchController::class, 'regionAnalytics'])->name('branches.manager.region.analytics');
    Route::get('/branches/manager/district-analytics', [BranchController::class, 'districtAnalytics'])->name('branches.manager.district.analytics');
});
