...
<div class="container-fluid">
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
        <div>
            <h2 class="fw-bold text-dark mb-2">
                <i class="fas fa-building me-2" style="color: #17479E;"></i>Branch Management Dashboard
            </h2>
            <p class="text-muted mb-0">{{ $branch->name }} - Comprehensive Analytics & Reporting</p>
        </div>
        <div class="d-flex align-items-center gap-2">
            <span class="badge px-3 py-2" style="background: linear-gradient(135deg, #17479E 0%, #4facfe 100%); color: white;">
                <i class="fas fa-user-tie me-1"></i>Branch Manager
            </span>
        </div>
    </div>
    ...
    <!-- Regional & District Analytics Buttons -->
        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center py-4">
                    ...
                    <h5 class="fw-bold mb-2">Regional Analytics</h5>
        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center py-4">
                    ...
                    <h5 class="fw-bold mb-2">District Analytics</h5>
                    <p class="text-muted mb-3">View detailed statistics for {{ $analyticsByDistrict->count() }} districts</p>
                    <button type="button" class="btn btn-info btn-lg" data-bs-toggle="modal" data-bs-target="#districtAnalyticsModal">
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-header" style="background: linear-gradient(135deg, #198754 0%, #20c997 100%);">
            <h5 class="mb-0 text-white fw-bold"><i class="fas fa-database me-2"></i>Child Table Statistics</h5>
        </div>
        <div class="card-body">
            <div class="row g-3">
                <!-- Loan Applications -->
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <small class="text-muted">Regions from enquiries registered by your branch users</small>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <small class="text-muted">Will auto-update based on region selection</small>
                        </div>
...
<div class="modal fade" id="regionalAnalyticsModal" tabindex="-1">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-body p-4">
                <div class="table-responsive">
                    <table class="table table-hover table-bordered" id="regionalTable">
...
// Initialize Regional Analytics DataTable
var regionalTable = null;
$('#regionalAnalyticsModal').on('shown.bs.modal', function () {
    if (regionalTable) {
        regionalTable.destroy();
    }

    regionalTable = $('#regionalTable').DataTable({
        processing: true,
        serverSide: false,
        ajax: {
            url: '{{ route("branches.manager.region.analytics") }}',
            type: 'GET',
            dataSrc: 'data',
            error: function(xhr, error, thrown) {
                console.error('Error loading regional analytics:', xhr.responseText);
                alert('Error loading regional analytics: ' + xhr.responseText);
            }
        },
        columns: [
            ...
            },
            {
                ...
                className: 'text-center',
                render: function(data) {
                    return '<span class="badge bg-warning text-dark fs-6">' + data + '</span>';
                }
            },
            {
                data: 'assigned',
        ...
        language: {
            ...
            info: 'Inaonyesha _START_ hadi _END_ ya _TOTAL_ mikoa',
            ...
            zeroRecords: 'Hakuna data inayopatikana',
            processing: 'Inapakia...'
        },
        responsive: true,
        autoWidth: false
...
// Initialize District Analytics DataTable
var districtTable = null;
$('#districtAnalyticsModal').on('shown.bs.modal', function () {
    ...
    districtTable = $('#districtTable').DataTable({
        ...
        serverSide: false,
        ajax: {
            url: '{{ route("branches.manager.district.analytics") }}',
            type: 'GET',
            dataSrc: 'data',
            error: function(xhr, error, thrown) {
                console.error('Error loading district analytics:', xhr.responseText);
                alert('Error loading district analytics: ' + xhr.responseText);
            }
        },
        columns: [
            { data: 'DT_RowIndex', orderable: false, searchable: false },
        ...
        language: {
            search: 'Tafuta:',
            lengthMenu: 'Onyesha _MENU_ kwa ukurasa',
            info: 'Inaonyesha _START_ hadi _END_ ya _TOTAL_ wilaya',
            infoEmpty: 'Hakuna data',
            infoFiltered: '(imechujwa kutoka _MAX_ jumla)',
            paginate: {
                first: 'Kwanza',
