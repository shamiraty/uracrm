...
public function process(LoanApplication $loanApplication)
{
    ...
    // Prepare the SMS message
    $message = "Hello " . $enquiry->full_name . ", your loan application for the requested amount of Tsh " . number_format( $requestedAmount) . " has been processed. The processed amount is " . $processedAmount . ". Your loan details will be communicated to you shortly.";
...
private function sendEnquirySMS($phone, $message)
{
    ...
    public function approve(LoanApplication $loanApplication)
    {
        ...
        // Prepare the SMS message
        $message = "Hello " . $enquiry->full_name . ", your loan application for the requested amount of Tsh" . number_format( $requestedAmount) . " has been approved. The approved amount is " . $approvedAmount . ". Further details and the next steps will be communicated to you shortly.";
    ...
    public function reject(LoanApplication $loanApplication)
{
    ...
    // Prepare the SMS message
    $message = "Hello " . $enquiry->full_name . ", unfortunately, your loan application for the amount of Tsh " . number_format( $requestedAmount). " has been rejected. For further details or to discuss alternative options, please contact us.";
