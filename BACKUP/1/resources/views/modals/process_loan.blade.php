{{-- <div class="modal fade" id="processLoanModal-{{ $enquiry->loanApplication->id }}" tabindex="-1" aria-hidden="true"> --}}
    @if($enquiry->enquirable_type === 'App\Models\LoanApplication' || isset($loanApplication))
    <div class="modal fade" id="processLoanModal-{{ $loanApplication->id ?? $enquiry->enquirable->id }}" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            {{-- <form action="{{ route('loans.process', ['loanApplication' => $enquiry->loanApplication->id]) }}" method="POST" onsubmit="showSpinner(this);"> --}}
                {{-- <form action="{{ route('loans.process', ['loanApplication' => $enquiry->loanApplication->id]) }}" method="POST"> --}}
                    <form action="{{ route('loans.process', ['loanApplication' => $loanApplication->id ?? $enquiry->enquirable->id]) }}" method="POST">
                        @csrf
                            ...
                            <div class="card">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <input type="number" class="form-control loan-input" data-type="basic_salary" value="{{ $enquiry->basic_salary }}" readonly style="background-color: #f8f9fa;">
                                    </li>
                                    <li class="list-group-item">
                                        <strong>Allowances:</strong>
                                        <input type="number" class="form-control loan-input" data-type="allowances" value="{{ $enquiry->allowances }}" readonly style="background-color: #f8f9fa;">
                                    </li>
                                    <li class="list-group-item">
                                        <strong>Take Home:</strong>
                                        <input type="number" class="form-control loan-input" data-type="take_home" value="{{ $enquiry->take_home }}" readonly style="background-color: #f8f9fa;">
                                    </li>
