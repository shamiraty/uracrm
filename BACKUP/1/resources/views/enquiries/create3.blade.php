...
--}}
                    ...
                    <div id="test-nl-1" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper2trigger1">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-lg-4">
                                ...
                                <input type="text" class="form-control" id="account_number" name="account_number" placeholder="Bank Account Number" disabled >
                            </div>
                            <div class="col-12 col-lg-4">
                                <!-- Include jQuery -->
                                ...
                                <select class="form-select select2" id="bank_name" name="bank_name" disabled>
    ...
    <option value="Mwanga Hakika Bank">Mwanga Hakika Bank</option>
                            ...
                            <div class="col-12 col-lg-4">
                                ...
                                <input type="number" class="form-control" id="basic_salary" name="basic_salary" placeholder="Enter basic salary" step="0.01"disabled>
                            </div>

                            <!-- Allowances -->
                            <div class="col-12 col-lg-4">
                                <label for="allowances" class="form-label">Allowances</label>
                                <input type="number" class="form-control" id="allowances" name="allowances" placeholder="Enter allowances" step="0.01"disabled>
                            </div>

                            <!-- Take Home Pay -->
                            <div class="col-12 col-lg-4">
                                <label for="take_home" class="form-label">Take Home Pay</label>
                                <input type="number" class="form-control" id="take_home" name="take_home" placeholder="Enter take home pay" step="0.01"disabled>
                            </div>
            ...
            <object id="pdfPreview" style="width: 100%; height: 400px;" type="application/pdf"class="bg-secondary"></object>
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true" id="loading_spinner" style="display: none;"></span>
                                </div>
                            </div>
                        </div><!---end row-->
...
<script>
    $(document).ready(function() {
        ...
        $('form').on('submit', function() {
            ...
            $('#submit_form').prop('disabled', true).html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Submitting...');

            // Optionally, you can display a separate spinner instead
