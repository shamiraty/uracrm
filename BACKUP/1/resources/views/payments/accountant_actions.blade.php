...
<div class="container-fluid">
    ...
    <div class="row g-4 mb-4">
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div>
                                    <h4 class="fw-bold mb-0">{{ number_format($analytics['total']) }}</h4>
                                    <p class="mb-0 opacity-75 small">Total Portfolio</p>
                                </div>
                            </div>
                        </div>
                        <div class="dropdown">
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div>
                                    <h4 class="fw-bold mb-0">{{ number_format($analytics['assigned_no_payment']) }}</h4>
                                    <p class="mb-0 opacity-75 small">Pending Initiation</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div>
                                    <h4 class="fw-bold mb-0">{{ number_format($analytics['initiated']) }}</h4>
            ...
            <div class="card border-0 shadow-lg h-100 position-relative overflow-hidden" style="background: linear-gradient(135deg, #20c997 0%, #17479E 100%);">
                <div class="card-body text-white p-3">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <div class="d-flex align-items-center mb-2">
                                <i class="fas fa-check-double fa-lg me-2"></i>
                                <div>
                                    <h4 class="fw-bold mb-0">{{ number_format($analytics['approved']) }}</h4>
                                    <p class="mb-0 opacity-75 small">Ready to Pay</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card border-0 shadow-lg h-100 position-relative overflow-hidden" style="background: linear-gradient(135deg, #198754 0%, #20c997 100%);">
                <div class="card-body text-white p-3">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div>
                                    <h4 class="fw-bold mb-0">{{ number_format($analytics['paid']) }}</h4>
                    ...
                    <small class="opacity-75 mt-2 d-block">
                        {{ $analytics['total'] > 0 ? round(($analytics['paid'] / $analytics['total']) * 100, 1) : 0 }}% of total portfolio
                    </small>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card border-0 shadow-lg h-100 position-relative overflow-hidden" style="background: linear-gradient(135deg, #dc3545 0%, #fd7e14 100%);">
                <div class="card-body text-white p-3">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div>
                                    <h4 class="fw-bold mb-0">{{ number_format($analytics['rejected']) }}</h4>
