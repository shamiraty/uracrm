    ...
    <div class="card basic-data-table">
        <div class="card-header">
            <h5 class="card-title mb-0"> <a href="#" class="btn btn-primary radius-30 mt-2 mt-lg-0">
                <i class="bx bxs-plus-square"></i> UraMobile applications
            </a></h5>
      </div>
      <div class="card-body">
        ...
        <table class="table border-primary-table mb-0" id="dataTable" data-page-length='10'>
                    ...
                    <tbody>
                        ...
                        @if($enquiry->enquirable && $enquiry->enquirable_type === 'App\Models\URAMobile')
                                <tr>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    @if($enquiry->enquirable_type === 'App\Models\URAMobile')
                                                        <li>
...
<script>
    function triggerLoanApprovalSend(loanId) {
        // Implement your approval logic here
        console.log("Approval triggered for loan ID:", loanId);
        // Add AJAX call to approve the loan if needed
    }
</script>