 ...
 <div class="modal fade" id="rejectLoanModal-{{ $enquiry->enquirable->id }}" tabindex="-1" aria-labelledby="rejectLoanModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('loans.reject',  ['loanApplication' => $enquiry->enquirable->id]) }}" method="POST"onsubmit="showSpinner(this);">
                @csrf
