...
@switch($enquiry->type)
    ...
    @case('refund')
        <li class="list-group-item d-flex justify-content-between">
            ...
            <strong>Refund Amount:</strong> <span>{{ number_format($enquiry->enquirable->refund_amount, 2) }}</span>
@else
<strong>Refund Amount:</strong> <span> No refund amount available.</span>
