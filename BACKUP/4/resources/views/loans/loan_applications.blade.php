...
<div class="container-fluid">
        ...
        <div class="card border-0 shadow-lg h-100" style="background: linear-gradient(135deg, #17479E 0%, #007bff 100%); overflow: hidden;">
            <div class="card-body text-white p-3 position-relative">
                ...
                <div class="d-flex flex-column">
                    ...
                    <p class="mb-0 small opacity-75 mt-1 text-white">Total Applications</p>
                </div>
    ...
    <div class="{{ $col_class }}">
        <div class="card border-0 shadow-lg h-100" style="background: linear-gradient(135deg, #0d6efd 0%, #3dd5f3 100%); overflow: hidden;">
            <div class="card-body text-white p-3 position-relative">
                <i class="fas fa-cog fa-3x position-absolute top-0 end-0 me-3 mt-3 opacity-25"></i>
                <div class="d-flex flex-column">
                    <p class="mb-1 opacity-75 small fw-semibold text-uppercase">Processed</p>
                    <h4 class="fw-bold mb-0 display-6 text-white">{{ number_format($analytics['processed']) }}</h4>
                    <p class="mb-0 small opacity-75 mt-1 text-white">{{ $analytics['total'] > 0 ? round(($analytics['processed'] / $analytics['total']) * 100, 1) : 0 }}% forwarded</p>
                </div>
    ...
    <div class="{{ $col_class }}"> 
        <div class="card border-0 shadow-lg h-100" style="background: linear-gradient(135deg, #28a745 0%, #20c997 100%); overflow: hidden;">
            <div class="card-body text-white p-3 position-relative">
                ...
                <div class="d-flex flex-column">
                    <p class="mb-1 opacity-75 small fw-semibold text-uppercase">Completed</p>
                    <h4 class="fw-bold mb-0 display-6 text-white">{{ number_format($analytics['total'] - $analytics['pending'] - $analytics['rejected'] - $analytics['processed']) }}</h4>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <small class="opacity-75">
                        <i class="fas fa-clipboard-check me-1"></i> Successfully Done
                    </small>
