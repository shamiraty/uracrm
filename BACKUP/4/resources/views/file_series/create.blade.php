...
<div class="container-fluid">
    ...
    <div class="file-series-header">
        <h1 class="header-title">
            <i class="bx {{ isset($fileSeries) ? 'bx-edit' : 'bx-plus' }}"></i>
            {{ isset($fileSeries) ? 'Edit File Series' : 'Create New File Series' }}
        </h1>
        <p class="header-subtitle">
            {{ isset($fileSeries) ? 'Update file series information and settings' : 'Add a new file series to the system database' }}
        </p>
    </div>
    ...
    <div class="modern-breadcrumb">
        <ul class="breadcrumb-nav">
            ...
            <li><span class="text-muted">•</span></li>
            <li class="text-muted">{{ isset($fileSeries) ? 'Edit' : 'Create' }}</li>
        </ul>
    </div>
            ...
            <div class="modern-card">
                <div class="modern-card-header">
                    <h5 class="modern-card-title">
                        ...
                        File Series {{ isset($fileSeries) ? 'Update' : 'Creation' }} Form
                    </h5>
                </div>
                    ...
                    <form action="{{ isset($fileSeries) ? route('file_series.update', $fileSeries) : route('file_series.store') }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating-custom">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                           value="{{ old('name', $fileSeries->name ?? '') }}"
                                           placeholder="Enter file series name" required>
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-floating-custom">
                                    ...
                                    <input type="text" class="form-control" id="code" name="code"
                                           value="{{ old('code', $fileSeries->code ?? '') }}"
                                           placeholder="Enter series code" required>
                                    @error('code')
                                        <div class="text-danger mt-2">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="form-help">
                            ...
                            <div class="form-help-text">
                                <ul class="mb-0">
                                    <li><strong>Series Name:</strong> A descriptive name for the file series (e.g., "Personnel Files")</li>
                                    <li><strong>Series Code:</strong> A unique identifier code (e.g., "PERS-001")</li>
                                    <li>Codes should be uppercase and may include hyphens</li>
                        ...
                        <div class="d-flex gap-3 justify-content-end mt-4">
                            ...
                            <button type="submit" class="modern-btn modern-btn-primary">
                                <i class="bx {{ isset($fileSeries) ? 'bx-save' : 'bx-plus' }}"></i>
                                {{ isset($fileSeries) ? 'Update Series' : 'Create Series' }}
                            </button>
                        </div>
                    </form>
                </div>
