...
<body>
    ...
    <div class="info-box">
        ...
        <p><strong>GENERATED ON:</strong> {{ strtoupper(now()->format('d F Y, H:i:s')) }}</p>
    ...
    <div class="profile-section">
        ...
        <div class="profile-item">
            ...
            <span class="profile-value">{{ strtoupper($user->email) }}</span>
        </div>
        <div class="profile-item">
            <span class="profile-label">PHONE NUMBER:</span>
            <span class="profile-value">{{ strtoupper($user->phone_number) }}</span>
        </div>
        <div class="profile-item">
        ...
        <div class="profile-item">
            ...
            <span class="profile-value">{{ strtoupper($user->created_at->format('d F Y')) }}</span>
        </div>
    </div>
    ...
    <p style="margin-bottom: 10px; font-size: 9pt; color: #666;">
        <strong>TOTAL RECORDS:</strong> {{ number_format($allEnquiries->count()) }} |
        <strong>LAST UPDATED:</strong> {{ $lastEnquiry ? strtoupper($lastEnquiry->created_at->format('d F Y')) : 'N/A' }}
    </p>
