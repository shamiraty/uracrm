...
class UserController extends Controller
{
    ...
    public function generatePDF(Request $request, $id)
    {
        ...
        if ($request->filled('date_range')) {
            ...
            switch ($dateRange) {
                case 'today':
                    $enquiriesQuery->whereDate('created_at', $now->toDateString());
                    break;
                case 'this_week':
                    $enquiriesQuery->whereBetween('created_at', [
                        $now->startOfWeek()->toDateString(),
                        $now->endOfWeek()->toDateString()
                    ]);
                    break;
                case 'this_month':
                    $enquiriesQuery->whereMonth('created_at', $now->month)
                ...
                case 'july_to_dec':
                    ...
                    break;
                case 'this_year':
                    $enquiriesQuery->whereYear('created_at', $now->year);
                    break;
                // 'lifetime' - no filter applied
            }
        }
