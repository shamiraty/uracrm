...
<div class="container-fluid py-4">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                        <div class="mb-2 mb-md-0">
                            <h1 class="h3 mb-1 fw-bold text-white">
                                <i class="fas fa-chart-area me-3"></i>Enquiry Management
                            </h1>
    ...
    @php
        // Class kwa ukubwa sawa kwa kadi 5 kwenye skrini kubwa (col-xl inagawa upana sawa)
        ...
        <div class="card border-0 shadow-lg h-100" style="background: linear-gradient(135deg, #17479E 0%, #007bff 100%); overflow: hidden;">
            <div class="card-body text-white p-3 position-relative">
                ...
                <div class="d-flex flex-column">
                    ...
                    <h4 class="fw-bold mb-0 display-6 text-white">{{ number_format($analytics['total'] ?? 0) }}</h4>
        ...
        <div class="card border-0 shadow-lg h-100" style="background: linear-gradient(135deg, #ffc107 0%, #fd7e14 100%); overflow: hidden;">
            <div class="card-body text-white p-3 position-relative">
                ...
                <div class="d-flex flex-column">
                    ...
                    <h4 class="fw-bold mb-0 display-6 text-white">{{ number_format($analytics['pending'] ?? 0) }}</h4>
                    <p class="mb-0 small text-white mt-1">{{ $analytics['total'] > 0 ? round((($analytics['pending'] ?? 0) / $analytics['total']) * 100, 1) : 0 }}% of total</p>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="progress flex-grow-1 me-3" style="height: 5px; background: rgba(255,255,255,0.2);">
                        <div class="progress-bar bg-light" role="progressbar" style="width: {{ $analytics['total'] > 0 ? (($analytics['pending'] ?? 0) / $analytics['total']) * 100 : 0 }}%"></div>
                    </div>
                    <div class="badge bg-light text-warning px-2 py-1 small fw-bold">ACTION NEEDED</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card border-0 shadow-lg h-100" style="background: linear-gradient(135deg, #0d6efd 0%, #3dd5f3 100%); overflow: hidden;">
            <div class="card-body text-white p-3 position-relative">
                ...
                <div class="d-flex flex-column">
                    ...
                    <h4 class="fw-bold mb-0 display-6 text-white">{{ number_format($analytics['assigned'] ?? 0) }}</h4>
                    <p class="mb-0 small opacity-75 mt-1 text-white">{{ $analytics['total'] > 0 ? round((($analytics['assigned'] ?? 0) / $analytics['total']) * 100, 1) : 0 }}% assigned</p>
                </div>
        ...
        <div class="card border-0 shadow-lg h-100" style="background: linear-gradient(135deg, #198754 0%, #20c997 100%); overflow: hidden;">
            <div class="card-body text-white p-3 position-relative">
                ...
                <div class="d-flex flex-column">
                    ...
                    <h4 class="fw-bold mb-0 display-6 text-white">{{ number_format($analytics['approved'] ?? 0) }}</h4>
                    <p class="mb-0 small opacity-75 mt-1 text-white">{{ $analytics['total'] > 0 ? round((($analytics['approved'] ?? 0) / $analytics['total']) * 100, 1) : 0 }}% approved</p>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="progress flex-grow-1 me-3" style="height: 5px; background: rgba(255,255,255,0.2);">
                        <div class="progress-bar bg-light" role="progressbar" style="width: {{ $analytics['total'] > 0 ? (($analytics['approved'] ?? 0) / $analytics['total']) * 100 : 0 }}%"></div>
                    </div>
        ...
        <div class="card border-0 shadow-lg h-100" style="background: linear-gradient(135deg, #dc3545 0%, #ff6b6b 100%); overflow: hidden;">
            <div class="card-body text-white p-3 position-relative">
                ...
                <div class="d-flex flex-column">
                    ...
                    <h4 class="fw-bold mb-0 display-6 text-white">{{ number_format($analytics['pending_overdue'] ?? 0) }}</h4>
                    <p class="mb-0 small opacity-75 mt-1 text-white">{{ $analytics['total'] > 0 ? round((($analytics['pending_overdue'] ?? 0) / $analytics['total']) * 100, 1) : 0 }}% overdue</p>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="progress flex-grow-1 me-3" style="height: 5px; background: rgba(255,255,255,0.2);">
                        <div class="progress-bar bg-light" role="progressbar" style="width: {{ $analytics['total'] > 0 ? (($analytics['pending_overdue'] ?? 0) / $analytics['total']) * 100 : 0 }}%"></div>
                    </div>
    ...
    <div class="row mb-4">
        <div class="col-12 d-flex justify-content-between align-items-center">
            ...
            <!-- Export PDF Button -->
            <div>
                <button type="button" class="btn btn-lg shadow" style="background: linear-gradient(135deg, #17479E 0%, #87CEEB 100%); color: white; border: none;" data-bs-toggle="modal" data-bs-target="#pdfExportModal">
