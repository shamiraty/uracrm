...
//-----------------------------------------------	
    ...
    // Export Enquiries to PDF - accessible to all authenticated users (uses SAME role logic as index)
    Route::get('/enquiries/export/pdf', [EnquiryController::class, 'exportEnquiriesPDF'])->name('enquiries.export.pdf');
