...
<div class="container-fluid">
    ...
    <div class="contribution-header">
        ...
        <p class="header-subtitle">
            Individual member contribution history and detailed breakdown
        </p>
    </div>
                ...
                <div class="col-md-4 text-end">
                    <div class="modern-dropdown dropdown">
                        ...
                        <ul class="modern-dropdown-menu dropdown-menu">
                            <li>
                                <a class="modern-dropdown-item" href="{{ route('deductions.export.csv', ['checkNumber' => $checkNumber]) }}">
                                    <i class="bx bx-file-doc"></i>
                                    Export to CSV
                                </a>
                            </li>
                            <li>
                                <a class="modern-dropdown-item" href="{{ route('exportMemberContributionPdf', ['checkNumber' => $checkNumber]) }}" target="_blank">
                    ...
                    <thead>
                        <tr>
                            ...
                            @foreach($deductionTypes as $type)
                                <th><i class="bx bx-coin me-1"></i>{{ strtoupper($type) }}</th>
                            @endforeach
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        @foreach($formattedData as $year => $months)
                            <tr class="year-row">
                                <td colspan="{{ count($deductionTypes) + 1 }}">
