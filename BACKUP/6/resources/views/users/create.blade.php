                        ...
                        <form id="userForm" action="{{ route('users.store') }}" method="POST">
                            ...
                            <div class="step-content d-none" id="step-1">
                                <div class="section-header">
                                    ...
                                    <p class="section-subtitle">Set user roles, permissions and status</p>
                                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Don't setup validation immediately to avoid validation on page load
});
...
function nextStep() {
    if (validateStep(currentStep)) {
        ...
        setTimeout(() => {
            stepElement.style.animation = 'shake 0.5s ease';
        }, 10);
    }
}
...
function setupValidation() {
    // Validation only starts after user interacts with fields
