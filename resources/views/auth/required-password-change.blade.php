...
<head>
    ...
    <title>URA SACCOS CRM | Password Change Required</title>
...
<body>
        ...
        <div class="form-box login">
            ...
            <div class="form-details">
                ...
                <p style="font-size: 0.9rem; opacity: 0.8; margin-top: 10px;">
                    Your password has expired and must be updated for security
                </p>
            ...
            <div class="form-content">
                ...
                <form action="{{ route('password.change.required.store') }}" method="POST" id="passwordChangeForm">
                    @csrf
                    ...
                    <div class="input-field @error('old_password') has-error @enderror">
                        ...
                        <span class="material-symbols-rounded input-icon toggle-password" id="toggleOldPassword">
                            visibility_off
                        </span>
                        @error('old_password')
                    ...
                    <div class="input-field">
                        ...
                        <span class="material-symbols-rounded input-icon toggle-password" id="togglePasswordConfirmation">
                            visibility_off
                        </span>
                    </div>
    ...
    <script>
        ...
        const toggleButtons = [
            { button: document.getElementById('toggleOldPassword'), input: document.getElementById('old_password') },
            { button: document.getElementById('togglePassword'), input: document.getElementById('password') },
            { button: document.getElementById('togglePasswordConfirmation'), input: document.getElementById('password_confirmation') }
        ];
        ...
        // Auto-focus old password field on load
