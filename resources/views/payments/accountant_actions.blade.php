...
<div class="container-fluid">
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Manage assigned payment enquiries and processing workflow</p>
        </div>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card border-0 shadow-lg h-100 position-relative overflow-hidden" style="background: linear-gradient(135deg, #17479E 0%, #4facfe 100%);">
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div>
                                    <h2 class="fw-bold mb-0">{{ number_format($analytics['total']) }}</h2>
                                    <p class="mb-0 opacity-75">Total Portfolio</p>
                                </div>
                            </div>
                        </div>
                        <div class="dropdown">
                            <button class="btn btn-sm btn-light btn-outline-light" data-bs-toggle="dropdown">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card border-0 shadow-lg h-100 position-relative overflow-hidden" style="background: linear-gradient(135deg, #87ceeb 0%, #4facfe 100%);">
                <div class="card-body text-white p-4">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div>
                                    <h2 class="fw-bold mb-0">{{ number_format($analytics['assigned_no_payment']) }}</h2>
                                    <p class="mb-0 opacity-75">Pending Initiation</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="progress mt-3" style="height: 4px; background: rgba(255,255,255,0.2);">
                        <div class="progress-bar bg-warning" style="width: {{ $analytics['total'] > 0 ? ($analytics['assigned_no_payment'] / $analytics['total']) * 100 : 0 }}%"></div>
                    </div>
                    <small class="opacity-75 mt-2 d-block">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card border-0 shadow-lg h-100 position-relative overflow-hidden" style="background: linear-gradient(135deg, #4facfe 0%, #17479E 100%);">
                <div class="card-body text-white p-4">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div>
                                    <h2 class="fw-bold mb-0">{{ number_format($analytics['initiated']) }}</h2>
                    ...
                    <div class="progress mt-3" style="height: 4px; background: rgba(255,255,255,0.2);">
                        <div class="progress-bar bg-info" style="width: {{ $analytics['total'] > 0 ? ($analytics['initiated'] / $analytics['total']) * 100 : 0 }}%"></div>
                    </div>
                    <small class="opacity-75 mt-2 d-block">
                        Processing {{ number_format($analytics['initiated']) }} payments
                    </small>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card border-0 shadow-lg h-100 position-relative overflow-hidden" style="background: linear-gradient(135deg, #20c997 0%, #17479E 100%);">
                <div class="card-body text-white p-4">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div>
                                    <h2 class="fw-bold mb-0">{{ number_format($analytics['approved']) }}</h2>
                                    <p class="mb-0 opacity-75">Ready to Pay</p>
                                </div>
                            </div>
                        </div>
                        <span class="badge bg-success px-2 py-1">READY</span>
                    </div>
                    <div class="progress mt-3" style="height: 4px; background: rgba(255,255,255,0.2);">
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <div class="badge bg-success-subtle text-success px-3 py-2">
                            <i class="fas fa-money-bill-wave me-1"></i>{{ number_format($analytics['paid']) }}
                        </div>
                    </div>
                    <div class="row g-3">
                        <div class="col-6 text-center">
                            <div class="p-3 bg-success-subtle rounded">
                                ...
                                <h4 class="fw-bold text-success mb-1">{{ $analytics['total'] > 0 ? round(($analytics['paid'] / $analytics['total']) * 100, 1) : 0 }}%</h4>
                        ...
                        <div class="col-6 text-center">
                            <div class="p-3 bg-primary-subtle rounded">
                                ...
                                <h4 class="fw-bold text-primary mb-1">{{ number_format($analytics['paid']) }}</h4>
        ...
        <div class="col-xl-4 col-lg-6">
            <div class="card border-0 shadow-lg h-100">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h6 class="fw-bold text-dark mb-0">Rejected Payments</h6>
                        <div class="badge bg-danger-subtle text-danger px-3 py-2">
                            <i class="fas fa-exclamation-triangle me-1"></i>{{ number_format($analytics['rejected']) }}
                        </div>
                    </div>
                    <div class="row g-3">
                        <div class="col-6 text-center">
                            <div class="p-3 bg-danger-subtle rounded">
                                ...
                                <h4 class="fw-bold text-danger mb-1">{{ $analytics['total'] > 0 ? round(($analytics['rejected'] / $analytics['total']) * 100, 1) : 0 }}%</h4>
                        ...
                        <div class="col-6 text-center">
                            <div class="p-3 bg-warning-subtle rounded">
                                ...
                                <h4 class="fw-bold text-warning mb-1">Review</h4>
            ...
            <div class="card border-0 shadow-lg h-100" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%);">
                <div class="card-body p-4">
                    <div class="text-center">
                        <i class="fas fa-analytics fa-3x text-primary mb-3"></i>
                        <h5 class="fw-bold text-dark mb-2">Performance Metrics</h5>
                        <div class="row g-2 mt-3">
                            <div class="col-4">
                                <div class="bg-white rounded p-2">
                                    <div class="text-primary fw-bold">{{ $analytics['total'] > 0 ? round((($analytics['initiated'] + $analytics['approved'] + $analytics['paid']) / $analytics['total']) * 100, 1) : 0 }}%</div>
                            ...
                            <div class="col-4">
                                <div class="bg-white rounded p-2">
                                    <div class="text-info fw-bold">Real-time</div>
                ...
                <div class="d-flex align-items-center">
                    ...
                    @if(request()->anyFilled(['search', 'status', 'date_from', 'date_to']))
                        <span class="badge bg-light text-dark ms-2">
                            <i class="fas fa-check-circle me-1"></i>Filters Active
                        </span>
                    @endif
                </div>
        ...
        <div class="card-header border-0" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%);">
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="fw-bold mb-1" style="color: #17479E;">Payment Portfolio</h5>
                                ...
                                <div class="d-flex justify-content-center">
                                    @if(!$enquiry->payment)
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-primary me-1"
                                                data-bs-toggle="modal" data-bs-target="#initiateModal-{{ $enquiry->id }}"
                                                title="Initiate Payment">
                                            <i class="fas fa-play"></i>
                                        </button>
                                        <button type="button" class="btn btn-sm btn-outline-info"
                                                data-bs-toggle="modal" data-bs-target="#viewModal-{{ $enquiry->id }}"
                                                title="View Details">
                                        ...
                                        @switch($enquiry->payment->status)
                                            @case('initiated')
                                                ...
                                                <button type="button" class="btn btn-sm btn-outline-danger"
                                                        data-bs-toggle="modal" data-bs-target="#rejectModal-{{ $enquiry->payment->id }}"
                                            ...
                                            @case('approved')
                                                ...
                                                <button type="button" class="btn btn-sm btn-outline-success me-1"
                                                        data-bs-toggle="modal" data-bs-target="#payModal-{{ $enquiry->payment->id }}"
                                                        title="Pay">
                                    ...
                                    <a href="{{ route('enquiries.show', $enquiry->id) }}"
                                       class="btn btn-sm btn-outline-secondary ms-1" title="View More Details">
